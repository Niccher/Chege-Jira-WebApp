...
<?= $this->section('content') ?>
    <div class="text-center mb-4">
        ...
        <h3 class="fw-bold text-body mb-1">Check Your Inbox</h3>
        <p class="text-muted font-14">We have sent an activation link to your email address. Please click the link to activate your workspace account.</p>
    </div>
    ...
    <div class="pt-3 border-top text-center">
        ...
        <p class="text-muted font-14 mb-0">
            Need to register a different account? <a href="<?= site_url('auth/register') ?>" class="text-primary fw-semibold ms-1">Create Account</a>
        </p>
    </div>
<?= $this->endSection() ?>
