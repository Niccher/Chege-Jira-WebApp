...
<?= $this->section('content') ?>
    <div class="text-center mb-4">
        ...
        <p class="text-muted font-14">Due to multiple failed login attempts, your account has been temporarily locked for security reasons.</p>
    </div>
    ...
    <div class="pt-3 border-top text-center">
        <p class="text-muted font-13 mb-0">
            Need urgent assistance? <a href="<?= site_url('faqs') ?>" class="text-primary text-decoration-none fw-semibold">Contact Support</a>
        </p>
    </div>
<?= $this->endSection() ?>
