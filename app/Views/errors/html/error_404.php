...
<head>
    <meta charset="utf-8" />
    <title>404 Page Not Found | <?= esc(setting('App.siteName')) ?></title>
                ...
                <div class="col-xxl-5 col-lg-6">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body p-4 text-center">
                            <img src="<?= base_url('assets/hyper/images/file-searching.svg') ?>" height="110" alt="Page Not Found" class="my-3">
                            <h1 class="text-danger fw-bold mt-2 display-6">404</h1>
                            <h4 class="text-dark mt-2 fw-semibold">Page Not Found</h4>
                            <p class="text-muted font-14 mt-2 mb-4">
                                It looks like the link you followed doesn't exist, has been moved, or you may have mistyped the URL.
                            </p>
