...
<head>
    <meta charset="utf-8" />
    <title>401 Authentication Required | <?= esc(setting('App.siteName')) ?></title>
                ...
                <div class="col-xxl-5 col-lg-6">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body p-4 text-center">
                            <img src="<?= base_url('assets/hyper/images/help-icon.svg') ?>" height="110" alt="Authentication Required" class="my-3">
                            <h1 class="text-info fw-bold mt-2 display-6">401</h1>
                            <h4 class="text-dark mt-2 fw-semibold">Authentication Required</h4>
                            <p class="text-muted font-14 mt-2 mb-4">
                                Your session has expired or you need to sign in to access this project dashboard.
                            </p>
