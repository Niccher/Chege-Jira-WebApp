...
<head>
    <meta charset="utf-8" />
    <title>400 Bad Request | <?= esc(setting('App.siteName')) ?></title>
                ...
                <div class="col-xxl-5 col-lg-6">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body p-4 text-center">
                            <img src="<?= base_url('assets/hyper/images/file-searching.svg') ?>" height="110" alt="Bad Request" class="my-3">
                            <h1 class="text-secondary fw-bold mt-2 display-6">400</h1>
                            <h4 class="text-dark mt-2 fw-semibold">Bad Request</h4>
                            <p class="text-muted font-14 mt-2 mb-4">
                                The request could not be understood or was missing required parameters. Please check your input.
                            </p>
